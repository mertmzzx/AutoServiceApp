...
namespace AutoService
{
    public partial class MainForm : MaterialForm
    {
        ...
        public MainForm(IMechanicService mechService, ICarService carService, IServiceRecordService recordService, IExportService exportService)
        {
            InitializeComponent();
        ...
        protected override async void OnLoad(EventArgs e)
        {
            ...
            var sz = Properties.Settings.Default.MainFormSize;
            if (sz.Width > 0 &&
                sz.Height > 0)
            {
                this.Size = sz;
